...
extern {
    ...
    pub fn zx_iob_create(
        options: u64 ,
        regions: *const u8 ,
        num_regions: usize ,
        ep0_out: *mut zx_handle_t ,
        ep1_out: *mut zx_handle_t 
    ) -> zx_status_t ;
    ...
    pub fn zx_restricted_bind_state(
        options: u32 ,
        out: *mut zx_handle_t 
    ) -> zx_status_t ;
    ...
    pub fn zx_restricted_kick(
        thread: zx_handle_t ,
        options: u32 
    ) -> zx_status_t ;


    pub fn zx_restricted_unbind_state(
        options: u32 
    ) -> zx_status_t ;


    pub fn zx_sampler_attach(
        iobuffer: zx_handle_t ,
        thread: zx_handle_t 
    ) -> zx_status_t ;


    pub fn zx_sampler_create(
        rsrc: zx_handle_t ,
        options: u64 ,
        config: *const zx_sampler_config_t ,
        per_cpu_buffers: *mut zx_handle_t 
    ) -> zx_status_t ;


    pub fn zx_sampler_start(
        iobuffer: zx_handle_t 
    ) -> zx_status_t ;


    pub fn zx_sampler_stop(
        iobuffer: zx_handle_t 
    ) -> zx_status_t ;
    ...
    pub fn zx_system_set_processor_power_level_domain(
        resource: zx_handle_t ,
        options: u64 ,
        cpus: *const zx_cpu_set_t ,
